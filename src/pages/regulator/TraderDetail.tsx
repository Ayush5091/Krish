    ...
    <DashboardLayout title={t.name} backTo="/regulator">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-exploitation/30 bg-card p-4 sm:p-5">
            <div className="flex items-center gap-3 sm:gap-4 mb-4">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-4 border-exploitation flex items-center justify-center flex-shrink-0">
                <span className="text-xl sm:text-2xl font-display font-bold text-exploitation">{t.exploitationScore}</span>
              </div>
              <div className="min-w-0">
                <h2 className="text-base sm:text-lg font-display font-semibold text-foreground truncate">{t.name}</h2>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              {[
                ...
                <div key={label} className="rounded-lg bg-muted p-2.5 sm:p-3 text-center">
          ...
          <button
            ...
            className={`w-full rounded-xl py-3 font-medium text-sm flex items-center justify-center gap-2 transition-all ${
              flagged
                ...
                : "bg-exploitation text-primary-foreground hover:opacity-90 active:opacity-80"
            }`}
          >
        ...
        <div className="rounded-xl border border-border bg-card p-4 sm:p-5">
          ...
          <svg viewBox="0 0 400 350" className="w-full max-w-sm mx-auto lg:max-w-none">
            {/* Trader node (center) */}
          ...
          <div className="flex items-center gap-3 sm:gap-4 mt-2 text-[10px] text-muted-foreground justify-center">
